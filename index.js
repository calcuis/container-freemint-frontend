...
const Render = ({ ArrowLoad: ArrowLoad2, hash: hash2, file, gate }) => {
  ...
  const callData = async () => {
    try {
      setIsLoading(true);
      const data_call = await fetch(`https://${gate}/ipfs/${hash2}/${file}.json`);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-container", children: data.filter((record) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-4/5 sm:w-3/5 text-start", children: [
        ...
        record.hash && record.file && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: `https://${gate}/ipfs/${record.hash}/${record.file}`, className: "w-64" }),
        record.hash && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "py-1" }),
        record.file1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-container", children: [
          record.hash1 && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: `https://${gate}/ipfs/${record.hash1}/${record.file1}`, className: "w-32" }),
          record.hash2 && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: `https://${gate}/ipfs/${record.hash2}/${record.file2}`, className: "w-32" }),
          record.hash3 && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: `https://${gate}/ipfs/${record.hash3}/${record.file3}`, className: "w-32" }),
          record.hash4 && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: `https://${gate}/ipfs/${record.hash3}/${record.file4}`, className: "w-32" }),
          record.hash5 && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: `https://${gate}/ipfs/${record.hash3}/${record.file5}`, className: "w-32" }),
          record.hash6 && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: `https://${gate}/ipfs/${record.hash3}/${record.file6}`, className: "w-32" })
        ] }),
...
const Welcome = ({ ArrowLoad: ArrowLoad2, gate }) => {
  const hash2 = "bafybeibba6rsulplzw2peejah5qf2db3sq33wa2qcw3od23bp46kaipdru";
  const file = "0";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Render, { ArrowLoad: ArrowLoad2, hash: hash2, file, gate });
};
...
const Item = ({ record, BtnLoad: BtnLoad2, theme, connectWalletHandler, accountBalance, kyuri, pigFee, loadPig }) => {
  ...
  const buyHandler = async () => {
    ...
    try {
      ...
      const transaction = await kyuri.connect(signer).mint(record.title, record.image);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: record.enable && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "m-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-bold", children: [
      record.image && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: record.image, className: "h-32 rounded-xl" }),
...
const Free = ({ ArrowLoad: ArrowLoad2, gate, BtnLoad: BtnLoad2, theme, connectWalletHandler, accountBalance, chainID, pigFee }) => {
  ...
  const callData = async () => {
    try {
      setIsLoading(true);
      const hash2 = "bafybeihg8qt64u7tagfjqh86qzuowbzivavshmbbo7catr54qphdqeob5u";
      const file = "1";
      const data_call = await fetch(`https://${gate}/ipfs/${hash2}/${file}.json`);
      const data2 = await data_call.json();
      setData(data2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-container", children: data.filter((record) => {
      ...
      return (
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Item, { record, BtnLoad: BtnLoad2, theme, connectWalletHandler, accountBalance, kyuri, pigFee, loadPig }, index)
      );
    }) })
  ] });
};
...
const RoleChanger = ({ theme, BtnLoad: BtnLoad2, connectWalletHandler, isOwner, isClosed, pigFee, contractBalance }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { children: [
      ...
      isAddress(values.ownerAddress) ? "✔️" : ensAddress && "✔️",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
        ...
        isAddress(values.transferAddressTo) ? "✔️" : ensTransfer && "✔️"
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
        ...
        isAddress(values.transferAddressTo) ? "✔️" : ensAddress && "✔️"
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
